...
interface KAPPAToken {
  function transfer(address recipient, uint256 amount) external returns (bool);
  function transferFrom(address sender, address recipient, uint256 amount) external returns (bool);
}

interface IKAPPATokenRouter {
...
contract KAPPATokenRouter is IKAPPATokenRouter, Ownable {
  ...
  KAPPAToken private token = KAPPAToken(0x185CB6fA1F2B03Ef38ADC61dab86a20282035592);
